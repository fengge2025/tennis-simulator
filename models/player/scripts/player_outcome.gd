...
static func action_prepare_outcome(_action_name: Player.ActionName) -> PlayerOutcome:
...
static func action_hit_and_run_outcome(_action_name: Player.ActionName) -> PlayerOutcome:
	return _action_outcome(_action_name)
